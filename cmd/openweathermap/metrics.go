...
type metrics struct {
	...
	Sunrise *prometheus.GaugeVec
	Sunset *prometheus.GaugeVec
	...
	WeatherDescription *prometheus.GaugeVec
...
func newMetrics(reg *prometheus.Registry) *metrics {
	...
	return &metrics{
		...
		Sunrise: factory.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: "openweathermap",
			Subsystem: "onecall",
			Name:      "sunrise",
		}, []string{"station"}),
		Sunset: factory.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: "openweathermap",
			Subsystem: "onecall",
			Name:      "sunset",
		}, []string{"station"}),
		...
		WindDirection: factory.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: "openweathermap",
			Subsystem: "onecall",
			Name:      "wind_direction",
		}, []string{"station"}),
		...
		WeatherDescription: factory.NewGaugeVec(prometheus.GaugeOpts{
			Namespace: "openweathermap",
			Subsystem: "onecall",
			Name:      "description",
			Help:      "Current weather condition text (https://openweathermap.org/weather-conditions)",
